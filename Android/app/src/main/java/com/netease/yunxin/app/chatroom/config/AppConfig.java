...
public class AppConfig {
  private static final String APP_KEY = "2f80a8029f27"; // 请填写应用对应的AppKey，可在云信控制台的”AppKey管理“页面获取
  public static final String APP_SECRET =
      "c252a67f204c14ce113fc6dbc480277f"; // 请填写应用对应的AppSecret，可在云信控制台的”AppKey管理“页面获取
